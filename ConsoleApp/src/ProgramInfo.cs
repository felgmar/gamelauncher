...
namespace ConsoleApp
{
    ...
    internal static class ProgramInfo
    {
        ...
        private static string ProgramName => Assembly.GetExecutingAssembly().GetName().Name ?? "gamelauncher";
        private static string ProgramVersion => Assembly.GetExecutingAssembly().GetName().Version?.ToString() ?? "0.0.1.0";
        private static string ProgramConfigurationMode =>
